		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "IBP Fiori App",
									"targetURL": "#sapbtpcosmomodulename-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapbtpcosmomodulename-display": {
								"semanticObject": "sapbtpcosmomodulename",
								"action": "display",
								"description": "SAP IBP Fiori App for AI simulation",
								"title": "IBP Fiori App",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.btp.cosmomodulename",
									"url": sap.ui.require.toUrl("sap/btp/cosmomodulename")
								}
							}
						}
					}
