		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "IBP Application",
									"targetURL": "#appibp2appibp2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"appibp2appibp2-display": {
								"semanticObject": "appibp2appibp2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=appibp2.appibp2",
									"url": sap.ui.require.toUrl("appibp2/appibp2")
								}
							}
						}
					}
